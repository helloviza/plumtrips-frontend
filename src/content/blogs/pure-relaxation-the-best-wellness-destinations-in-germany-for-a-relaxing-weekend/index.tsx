...
export default function Post(){return(<article className="bg-gradient-to-b from-slate-50 to-white">
  ...
  <main className="mx-auto max-w-4xl px-4 py-10">
    ...
    <div className="mt-12 rounded-2xl border bg-white p-6 shadow-md"><h3 className="text-lg md:text-xl font-bold">Plan it with Plumtrips âœˆï¸</h3><p className="mt-2 text-slate-700">We'll align spa slots, sauna circuits, and slow-food tables.</p><div className="mt-5"><a href="/go/concierge" className="inline-flex rounded-full bg-[#d06549] px-6 py-3 text-white font-semibold hover:bg-[#c2513d]">Design My Wellness</a></div></div>
  </main>
</article>)}
