          ...
          {fields ? fields : (
            <>
              ...
              <div className="space-y-1.5">
                ...
                <Input placeholder="john@company.com" className="bg-transparent border-white/40 text-white placeholder:text-white/50 h-10 backdrop-blur-sm focus:border-white focus:ring-white" type="email" />
              </div>
              
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-semibold text-white/80 uppercase tracking-wider drop-shadow-sm">Team Size</label>
                  <Input placeholder="Min 10" className="bg-transparent border-white/40 text-white placeholder:text-white/50 h-10 backdrop-blur-sm focus:border-white focus:ring-white" />
                </div>
                <div className="space-y-1.5">
