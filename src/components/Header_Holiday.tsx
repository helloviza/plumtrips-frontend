...
export function Header_Holiday() {
  return (
    <div className="absolute top-[72px] left-0 right-0 z-40 bg-transparent hidden lg:block">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-14 text-[14px] font-medium text-white/90">
